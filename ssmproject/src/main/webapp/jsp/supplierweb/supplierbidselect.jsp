...
<div class="container-fluid">
    <div class="row" style="height: 50px;background-image: url(/img/title.jpg);">
        ...
        <div class="col-sm-2"><span style="color: beige;font-size: 24px;">供应商后台</span></div>
    </div>
            ...
            <table class="table table-condensed table-bordered">
                ...
                <c:forEach items="${projectbiddings}" var="v">
                    <tr>
                        ...
                        <td style="vertical-align: middle;">${v.money}</td>
                        <td style="vertical-align: middle;color: red;">
                            <c:forEach items="${v.projectbiddingfileList}" var="v2">
                                ${v2.filepath}&nbsp;&nbsp;<a href="/projectbiddingfiledowload/${v2.id}">下载</a><br>
                            </c:forEach>
                        </td>
